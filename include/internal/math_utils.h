...
////////////////////////////////////////////////////////////////////////////////
// sumc
// - sum all component of value v
////////////////////////////////////////////////////////////////////////////////
inline __host__ __device__ float sumc(float a) { return a; }
inline __host__ __device__ float sumc(float2 a) { return a.x + a.y; }
inline __host__ __device__ float sumc(float3 a) { return a.x + a.y + a.z; }
inline __host__ __device__ float sumc(float4 a) { return a.x + a.y + a.z + a.w; }

inline __host__ __device__ int sumc(int a) { return a; }
inline __host__ __device__ int sumc(int2 a) { return a.x + a.y; }
inline __host__ __device__ int sumc(int3 a) { return a.x + a.y + a.z; }
inline __host__ __device__ int sumc(int4 a) { return a.x + a.y + a.z + a.w; }

inline __host__ __device__ uint sumc(uint a) { return a; }
inline __host__ __device__ uint sumc(uint2 a) { return a.x + a.y; }
inline __host__ __device__ uint sumc(uint3 a) { return a.x + a.y + a.z; }
inline __host__ __device__ uint sumc(uint4 a) { return a.x + a.y + a.z + a.w; }
...
// dot product
////////////////////////////////////////////////////////////////////////////////
inline __host__ __device__ float dot(float a, float b) { return a * b; }
...
inline __host__ __device__ int dot(int a, int b) { return a * b; }
...
inline __host__ __device__ uint dot(uint a, uint b) { return a * b; }
